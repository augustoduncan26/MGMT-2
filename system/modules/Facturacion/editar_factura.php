<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos 		=	"fact_clientes.id_cliente, fact_clientes.nombre_cliente, fact_clientes.telefono_cliente, fact_clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		$sql_factura 	=	mysqli_query($con,"select $campos from facturas, fact_clientes where facturas.id_cliente=fact_clientes.id_cliente and id_factura='".$id_factura."'");
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select class="form-control input-sm" id="id_vendedor" name="id_vendedor">
									<?php
										$sql_vendedor 	=	mysqli_query($con,"select * from usuarios Where id_perfil = '5' order by apellido");
