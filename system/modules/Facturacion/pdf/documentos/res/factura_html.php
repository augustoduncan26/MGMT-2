...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                   <!-- &copy; <?php //echo ".pw "; //echo  $anio=date('Y');?> -->
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
		...
		<tr>
           <td style="width:50%;" >
			<?php 
				$sql_cliente=mysqli_query($con,"select * from fact_clientes where id_cliente='$id_cliente'");
       ...
       <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				$sql_user=mysqli_query($con,"select * from usuarios where id_usuario='$id_vendedor' and perfil = '5'");
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from fact_products, fact_tmp where fact_products.id=fact_tmp.id_producto and fact_tmp.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	...
	$impuesto 	=	get_row('fact_perfil','impuesto', 'id_perfil', 1);
...
$delete=mysqli_query($con,"DELETE FROM fact_tmp WHERE session_id='".$session_id."'");
?>