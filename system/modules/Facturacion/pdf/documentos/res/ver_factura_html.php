    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
       ...
       <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				$sql_user=mysqli_query($con,"select * from usuarios where id_usuario='$id_vendedor'");
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from fact_products, detalle_factura, facturas where fact_products.id=detalle_factura.id_producto and detalle_factura.numero_factura=facturas.numero_factura and facturas.id_factura='".$id_factura."'");
