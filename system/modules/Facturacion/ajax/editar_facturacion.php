...
<?php
	$sumador_total 	=	0;
	$sql 			=	mysqli_query($con, "select * from fact_products, facturas, detalle_factura where facturas.numero_factura=detalle_factura.numero_factura and  facturas.id_factura='$id_factura' and fact_products.id=detalle_factura.id_producto");
