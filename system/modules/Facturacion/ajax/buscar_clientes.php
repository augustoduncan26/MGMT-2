<?php
	...
	if ( isset($_GET['id']) ) {
		...
		$query 		=	mysqli_query($con, "select * from fact_facturas where id_cliente='".$id_cliente."'");
		$count 		=	mysqli_num_rows($query);

		if ( $count == 0 ) {

			if ( $delete1 	=	mysqli_query($con , "DELETE FROM fact_clientes WHERE id_cliente='".$id_cliente."'")){
?>
...
<?php
	...
	if( $action == 'ajax' ) {
		...
		$sWhere 	.=	" Where id_empresa = '".$_SESSION['id_empresa']."' order by nombre_cliente ";
...
?>
					...
					<tr>
						...
						<td><?php echo substr(utf8_decode($direccion_cliente),0,40).'...';?></td>
