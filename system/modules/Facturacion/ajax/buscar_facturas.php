...
<?php
	...
	if( $action == 'ajax' ) {
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sTable 	= 	"facturas, fact_clientes, usuarios";
		 $sWhere 	=	"";
		 $sWhere 	.=	" WHERE facturas.id_cliente=fact_clientes.id_cliente and facturas.id_vendedor=usuarios.id_usuario";
		
		if ( $_GET['q'] != "" ) {
		
		$sWhere		.= 	" and  (fact_clientes.nombre_cliente like '%$q%' or facturas.numero_factura like '%$q%')";
...
<?php
				while ( $row 	=	mysqli_fetch_array($query) )	{
						...
						$nombre_vendedor=	$row['nombre'];//." ".$row['lastname'];
