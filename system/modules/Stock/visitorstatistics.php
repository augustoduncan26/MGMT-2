<?php
	...
	if ((@preg_match("Nav", $_SERVER["HTTP_USER_AGENT"])) || (@preg_match("Gold", $_SERVER["HTTP_USER_AGENT"])) || (@preg_match("X11", $_SERVER["HTTP_USER_AGENT"])) || (@preg_match("Mozilla", $_SERVER["HTTP_USER_AGENT"])) || (@preg_match("Netscape", $_SERVER["HTTP_USER_AGENT"])) AND (!@preg_match("MSIE", $_SERVER["HTTP_USER_AGENT"])) AND (!@preg_match("Konqueror", $_SERVER["HTTP_USER_AGENT"])) AND (!@preg_match("Yahoo", $_SERVER["HTTP_USER_AGENT"])) AND (!@preg_match("Firefox", $_SERVER["HTTP_USER_AGENT"]))) $browser = "Netscape";
