...
<div class="COMMON_titulo" id="USR_titulo">&nbsp;<image name="iconoUser" id="iconoUser" src="<?php $objCMS->imagenURL('calendar.png');?>" border="0" width="19px" height="19px" title="Roles de turnos" />
...
<font size="1" face="Verdana, Geneva, sans-serif"></font>
    <table border="0" align="center" class="bordeTodalaTabla_2  bordered" style="width:60%;font-family:Verdana, Geneva, sans-serif; font-size:12px; background-color:#FFF">
      <tr align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:12px">
        <td width="25%" bgcolor="#EBEBEB" id="OptNuevo" onmouseover="SombreadoCampos('OptNuevo','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptNuevo','0')"><a href="?pag=rolturno" id="Nuevo"><image name="infoEditar" id="infoEditar" src="<?php $objCMS->imagenURL('add.png');?>" border="0" /> Nuevo</a></td>
       <?PHP
	   if($objPermiso->tienePermiso(41100103)):
	   ?>
        <td width="20%" bgcolor="#EBEBEB" id="OptEdit" onmouseover="SombreadoCampos('OptEdit','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptEdit','0')"><a href="?pag=defaultAdmin&pags=buscarRT&optm=sera&padr=desp"><image name="infoEditar" id="infoEditar" src="<?php $objCMS->imagenURL('buscar_03.png');?>" border="0" /> 
        Buscar</a></td>
         <?PHP ;else: echo '<td bgcolor="#EBEBEB">&nbsp;</td>'; endif;?>
        <td width="27%" bgcolor="#EBEBEB" id="OptElim" onmouseover="SombreadoCampos('OptElim','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptElim','0')"><a href="#" onclick="cambiarDisplay('VerAyuda','true')"><image name="ayuda" id="ayuda" src="<?php $objCMS->imagenURL('ayuda2.png');?>" border="0" /> Ayuda</a></td>
       <td width="28%" bgcolor="#EBEBEB" id="OptRefresh" onmouseover="SombreadoCampos('OptRefresh','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptRefresh','0')"><a href="?pag=defaultAdmin&amp;pags=ctroopera"><image name="ayuda" id="ayuda" src="<?php $objCMS->imagenURL('calltaker.png');?>" border="0" /> Regresar al Men&uacute;</a></td>
	   </tr>
      ...
      <tr style="font-family:Verdana, Geneva, sans-serif; font-size:12px">
        ...
        <tr id="Line">
        <td colspan="4" height="5px" id="OptLine" onmouseover="SombreadoCampos('OptLine','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptLine','0')" bgcolor="#EBEBEB"></td>
        </tr>
...
Total en Administrativo</td>
        ...
        <tr>
        <td colspan="4" class="fondoAbajoGris" id="OptAreas3" onmouseover="SombreadoCampos('OptAreas3','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptAreas3','0')">&nbsp;</td>
      </tr>
    </table>
  </div>
  <br />
...
<table id="VerAyuda" width="90%" border="0" class="bordeTodalaTabla_2" cellpadding="0" cellspacing="0" align="center" style="display:none;">
 ...
 <form name="YaMatriz" id="YaMatriz" method="post" action="">
	...
	<tr bgcolor="#EBEBEB">  
	<td style="font-size:10px;font-family:Verdana" align="right"><a href="?pag=rolturno&opt=back" onclick="javascript: if(!confirm('Esta seguro?')){ return false;}"> <image name="ayuda" id="ayuda" src="<?php $objCMS->imagenURL('regresar.GIF');?>" border="0" /> REGRESAR</a></td>	
	</tr>
	<tr>  
	<td>
	...
	<tr bgcolor="#EBEBEB">
		...
		<td width="236" align="center"  id="OptOpcion5" onmouseover="SombreadoCampos('OptOpcion5','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptOpcion5','0')"><input type="submit" name="buttonSalir" id="buttonSalir" value="Salir" class="Estilo_botones" onclick="javascript: if(confirm('Esta seguro?')){ self.location=('?pag=defaultAdmin')}else{return false}" /></td>
		<td align="center" width="113"  id="OptOpcion7" onmouseover="SombreadoCampos('OptOpcion7','1'); this.style.Cursor='pointer'" onmouseout="SombreadoCampos('OptOpcion7','0')"> <image name="ayuda" id="ayuda" src="<?php $objCMS->imagenURL('ayuda2.png');?>" border="0" /> <a href="#" onclick="cambiarDisplay('VerAyuda','true')">Ayuda</a></td>
		</tr>
	<tr bgcolor="#EBEBEB">
