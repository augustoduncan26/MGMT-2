              ...
              <div class="x_content">
                ...
                <table id="tabla-list-perfiles" class="table table-striped table-bordered table-hover table-responsive">
                  ...
                  <tbody id="tbody-table-perfiles">
                    ...
                    ?>
                      <tr>
                        <td <?php if($value['activo']==0) { echo 'class="row-yellow-transp"'; } ?>><?=$value['id_usuario']?></td>
                        ...
                        <td class="text-center">
                          ...
                          <a class="btn btn-xs btn-green " data-original-title="Permisos" data-toggle="modal" role="button" href="#user-permission" onclick="limpiarCampos();showUserPermisos('<?php echo $value['id_usuario']; ?>');"><i class="fa fa-key"></i></a>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form name="add_usuarios" id="add_usuarios" method="post" action="#SELF" enctype="multipart/form-data">
