...
<!-- onclick="$('#myModal').modal({'backdrop': 'static'});" -->
  <a data-toggle="modal" class="btn btn-primary"  role="button" href="#formulario_nuevo" onclick="$('#mssg-label').html('');$('#mssg-label').hide();$('#nombre').focus();">[+] Nueva Habitación</a>
   <div class="row">
      <div class="col-sm-12">
       <div class="panel panel-default">
          <div class="panel-heading">
            <i class="clip-checkbox-partial"></i>Administrar Habitaciones
           </div>
...
function addRoom () {
  ...
  let route = "app/controllers/habitaciones.php?add=1&tipo="+tipo+"&nombre="+nombre+"&total_beds="+total_beds+"&precio="+precio+"&estado="+estado+"&nocache=<?php echo rand(99999,66666)?>";
  $.ajax({
    headers: {
...
function deleteRow ( id ) {
  let route = "app/controllers/habitaciones.php?delete=1&id="+id+"&nocache=<?php echo rand(99999,66666)?>";
  $.ajax({
    headers: {
      Accept        : "application/json; charset=utf-8",
      "Content-Type": "application/json: charset=utf-8"
