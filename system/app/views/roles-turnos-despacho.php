...
<style>
    ...
    .alert , .otros-params {display: none;}
...
<div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <i class="fa fa-calendar"></i>Roles de Turnos
                </div>
                ...
                <div class="container">
                  ...
                  <select class="select_areas" id="select_areas[]" name="select_areas[]" ><!-- multiple -->
                    ...
                    <?php 
                      if (isset($ListaAreas)) {
                        foreach ($ListaAreas['resultado'] as $key => $value) {
...
<table id="VerAyuda" border="0" class="bordeTodalaTabla_2" cellpadding="0" cellspacing="0" align="center" style="display:none;width:60%; font-family:Verdana, Geneva, sans-serif; font-size:12px">
      <tr bgcolor="#EBEBEB">
        ...
        <td>&nbsp;</td>
        <td align="right">
        <a href="#" onclick="cambiarDisplay('VerAyuda','true')" style="cursor:pointer"><image name="cerrar" id="cerrar" src="assets/image/close.gif" title="Cerrar" border="0" onmouseover="
			  javascript:
      ...
      <tr>
        <td colspan="3">&nbsp;[ <image name="infoEditar" id="infoEditar" src="assets/image/add.png" border="0" /> ] Hacer un nuevo rol de turno</td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;[ <image name="infoEditar" id="infoEditar" src="assets/image/buscar_03.png" border="0" /> ] Buscar roles de turnos, por criterio de consulta</td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;[ <image name="ayuda" id="ayuda" src="assets/image/actualiza.png" border="0" width="15px" /> ] Actualizar la pantalla (Se pierde cualquier opci&oacute;n seleccionada)</td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp; 1. Para generar el rol de turno debe seleccionar (&Aacute;rea, Cuantos usuarios, Fecha).</td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <tr>
        <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp; 4. Tiene la opci&oacute;n de imprimir el rol de turno [ <image name="infoEditar" id="infoEditar" src="assets/image/print.gif" border="0" /> ], si es que lo desea.</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<font size="1" face="Verdana, Geneva, sans-serif"></font>
    <table border="0" align="center" class="bordeTodalaTabla_2  bordered" style="width:60%;font-family:Verdana, Geneva, sans-serif; font-size:12px; background-color:#FFF">
      <tr align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:12px">
        <td width="25%" bgcolor="#EBEBEB" id="OptNuevo" ><a href="?pag=rolturno" id="Nuevo"><image name="infoEditar" id="infoEditar" src="assets/image/add.png" border="0" /> Nuevo</a></td>
       <?PHP
	   if($objPermiso->tienePermiso(41100103)):
	   ?>
        <td width="20%" bgcolor="#EBEBEB" id="OptEdit" ><a href="?pag=defaultAdmin&pags=buscarRT&optm=sera&padr=desp"><image name="infoEditar" id="infoEditar" src="assets/image/buscar_03.png" border="0" /> 
        Buscar</a></td>
         <?PHP ;else: echo '<td bgcolor="#EBEBEB">&nbsp;</td>'; endif;?>
        <td width="27%" bgcolor="#EBEBEB" id="OptElim"  ><a href="#" onclick="cambiarDisplay('VerAyuda','true')"><image name="ayuda" id="ayuda" src="assets/image/ayuda2.png" border="0" /> Ayuda</a></td>
       <td width="28%" bgcolor="#EBEBEB" id="OptRefresh" ><a href="?pag=defaultAdmin&amp;pags=ctroopera"><image name="ayuda" id="ayuda" src="assets/image/calltaker.png" border="0" /> Regresar al Men&uacute;</a></td>
	   </tr>
      <tr style="font-family:Verdana, Geneva, sans-serif; font-size:12px" height="100px">
        <td  id="OptAreas" onmouseover="this.style.Cursor='pointer'" valign="middle" align="center">&nbsp;&nbsp; Seleccione un &Aacute;rea:<br /><br />
      <a href="#" onclick="cambiarDisplay('OtrosParam','true')" style="text-decoration:blink; color:#600">Click Otros Parametros.</a><!--&Aacute;reas:
        ...
        ?>
        --></td>
        <td colspan="2" align="center" id="OptLisArea" onmouseover=" this.style.Cursor='pointer'" >
        	...
        	echo '
				...
				if($ListaAreas != false){
					foreach ($ListaAreas['resultado'] as $reg){
						echo	'<option value="'.$reg['id'].'">'.strtoupper($reg['name']).'</option>';
			 		}
				}
		echo '</select>';
		echo '';
        ...
        <td id="OptBotonGen" align="center" onmouseover=" this.style.Cursor='pointer'" >
      ...
      <tr style="font-family:Verdana, Geneva, sans-serif; font-size:12px">
        <td colspan="2" align="center"  id="OptAreas2" onmouseover="this.style.Cursor='pointer'" >Cuantos usuarios:
          ...
          <?php
			...
			echo  '</select>';
		?>        </td>
        <td colspan="2" align="center"  id="OptAreas4" onmouseover=" this.style.Cursor='pointer'" > Fecha:  de:
        ...
        <tr id="Line">
        <td colspan="4" height="5px" id="OptLine" onmouseover="this.style.Cursor='pointer'" bgcolor="#EBEBEB"></td>
        </tr>
         <tr id="OtrosParam" style="display:none;font-family:Verdana, Geneva, sans-serif; font-size:12px">
        <td align="center" id="OptEspecial" onmouseover="this.style.Cursor='pointer'" >Especial: <br /><font color="#660000">(Seleccionar mas de uno: ctrl+click)</font></td>
        <td colspan="2" id="OptEspecial2" onmouseover="this.style.Cursor='pointer'"  align="center">
...
Total en Administrativo</td>
        ...
        <tr>
        <td colspan="4" class="fondoAbajoGris" id="OptAreas3" onmouseover="this.style.Cursor='pointer'" >&nbsp;</td>
      </tr>
    </table>
  </div>
<?php */ ?>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="bordeTodalaTabla_2" width="60%" style="font-family:Verdana, Geneva, sans-serif; font-size:12px">
  <tr bgcolor="#EBEBEB" >
    ...
    <td width="5%" align="center"><image name="cerrar" id="cerrar" src="assets/image/close.gif" title="Cerrar" border="0" onclick="tjavascript: self.location=('?pag=rolturno')" onmouseover='this.style.cursor="pointer"'></td>
  </tr>
  <tr>
...
<table id="VerAyuda" width="98%" border="0" class="bordeTodalaTabla_2" cellpadding="0" cellspacing="0" align="center" style="display:none;">
 ...
 <form name="YaMatriz" id="YaMatriz" method="post" action="">
	<table width="98%" border="0" class="bordeTodalaTabla_2" align="center">
	<!-- <tr bgcolor="#EBEBEB">  
    ...
    <?PHP if(isset($P_Err) && $P_Err < 1):?>
        ...
        if(!confirm('Esta seguro?')){ 
           ...
           " />
           <div class="clearfix">&nbsp;</div>
           <?PHP //echo isset($P_Areas)?$P_Areas:'';?>
          <?PHP endif;?>
    </td>
		<!-- <td align="center" width="113"  id="OptOpcion7" onmouseover=" this.style.Cursor='pointer'"  > <?PHP echo isset($P_Areas)?$P_Areas:'';?></td> -->
		</tr>
	<tr>
	  <td colspan="8" style="width:100px"><?php echo $P_TDMeses; ?>
      <div class="mensajes" id="error" align="left" style="background-color:#FFF;"></div>
      </td>
	  </tr>
	<tr>
	  <td colspan="6"  style="width:100px">
      <div id="TabbedPanels1" class="TabbedPanels"><!-- background-color:#FFF -->
