...
<div class="row view-container">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="container">
      <div class="col-md-7">
      <h4><i class="clip-calendar-3"></i> Lista de Exámenes
    <button data-original-title="Asistente en línea" data-content="Click para ver el asistente" data-placement="right" data-toggle="modal"  data-trigger="hover" class="btn open-assistant btn-xs btn-green tooltips"><i class="clip-info"></i></button></h4>
      </div>
             ...
             <table class="table table-bordered table-hover" id="sample-table-4">
               ...
               <tbody>
                <div class="alert alert-danger">Todos los campos son necesarios</div>
                 ...
                 <tr>
                   <td width="30%">Fecha [mes/dia/año] </td> 
