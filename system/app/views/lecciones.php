...
<div class="row view-container">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="container">
      <div class="col-md-7">
      <h4><i class="clip-list-2"></i> Lista de Lecciones</h4>
      </div>
      <div class="col-md-5 text-right">
      <a data-toggle="modal" class="btn btn-primary"  role="button" href="#formulario_nuevo" onclick="$('#nombre').focus();">[+] Nueva Lección</a>
