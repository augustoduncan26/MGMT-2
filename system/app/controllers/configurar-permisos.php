...
if ( isset($_GET['add']) &&  $_GET['add'] == 1 && $_GET['nombre'] != '') {
	...
	if ($busca['total'] > 0 ) {
		...
		$P_Campos 		=	'nombre,permiso,permiso_padre,id_cia,active,created_at';
...
if ( isset($_GET['edit']) &&  $_GET['edit'] == 1 && $_GET['nombre'] != '' && $_GET['permiso'] !='') {
	$P_Valores 	= 	" nombre = '".$_GET['nombre']."', permiso = '".$_GET['permiso']."', permiso_padre = '".$_GET['permiso_padre']."',  active = '".$_GET['activo']."'";
