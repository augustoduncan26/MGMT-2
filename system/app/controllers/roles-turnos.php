<?php
	...
	if(isset($_GET['cancel']) && $_GET['cancel'] == 'rolback')
	{
		...
		$daysInMonth	= cal_days_in_month(CAL_GREGORIAN, $splitDate[1], $splitDate[0]);
		$searchExistRol     = $objMante->BuscarLoQueSea('*',PREFIX.'rolturn','area = '.$area.' and meses = '.$monthName[$splitDate[1]].' and active = 1 and id_cia = '.$id_cia);
