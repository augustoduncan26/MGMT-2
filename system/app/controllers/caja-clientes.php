...
if ( $_GET['add'] == 1 && $_GET['nombre'] != '') {
	...
	$P_Campos 		=	'nombre_cliente,telefono_cliente,email_cliente,direccion_cliente,activo,date_added,id_empresa';
	$P_Valores 		=	"'".$_GET['nombre']."','".$_GET['telefono']."','".$_GET['email']."','".$_GET['direccion']."',1,NOW(),'".$id_empresa."'";
...
if ( $_GET['edit'] == 1 && $_GET['nombre'] != '') {
	...
	$P_Valores 	= 	" nombre_cliente = '".$_GET['nombre']."', telefono_cliente = '".$_GET['telefono']."', email_cliente = '".$_GET['email']."', direccion_cliente = '".$_GET['direccion']."', activo = '".$_GET['activo']."'";
