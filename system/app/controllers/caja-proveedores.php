...
if ( $_GET['edit'] == 1 && $_GET['nombre'] != '' && $_GET['tipo'] !='') {
	...
	$P_Valores 	= 	" codigo = '".$_GET['nombre']."', tipo_habita = '".$_GET['tipo']."', price = '".number_format($_GET['precio'],2)."', total_beds = '".$_GET['total_beds']."', cleaning = '".$_GET['cleaning']."', activo = '".$_GET['activo']."'";
