...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    const UPGRADE_WINDOW = false; //365 + 7; // days. 1 week leeway, for tz shift reasons too
    const INVALID_LICENSE_URL = false; //'https://fullcalendar.io/docs/schedulerLicenseKey#invalid';
    const OUTDATED_LICENSE_URL = false; // 'https://fullcalendar.io/docs/schedulerLicenseKey#outdated';
