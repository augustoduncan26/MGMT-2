...
$data       = $ObjMante->BuscarLoQueSea('*',PREFIX.'events','id = '.$_GET['id'],'extract');

?>

<label id="mssg-edit-eventos" style="color:red"></label>
<table class="table table-bordered" id="sample-table-4">
  ...
  <tbody>
    <tr>
      ...
      <td width="70%"><input autofocus="" name="nombre" type="text" class="form-control" id="txt_nombre" placeholder="Nombre" value="<?php echo $data['nombre']; ?>">
    ...
    <tr>
      ...
      <td width="70%"><input autofocus="" name="txt_precio" type="number" min="1" step="0.01" class="form-control" id="txt_precio" placeholder="Precio" value="<?php echo $data['precio']; ?>">
