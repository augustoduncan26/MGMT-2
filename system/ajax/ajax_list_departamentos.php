...
$sel1       = $ObjMante->BuscarLoQueSea('*',PREFIX.'mant_departamentos','id_cia = '.$id_empresa,'array');
    ...
    <table id="list-table-direcciones" class="table table-striped table-bordered table-hover">
      ...
      ?>
        <tr>
          ...
          <!-- <td <?php if($datos['active']==0) { echo 'class="row-yellow-transp"'; } ?>><?=$datos['id_ceo']?></td> -->
          <td <?php if($datos['active']==0) { echo 'class="row-yellow-transp"'; } ?>><?=$datos['telephone']?></td>
